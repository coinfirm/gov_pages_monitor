...
def make_url(para):
    return "https://www.instantmarkets.com" + str(para)
    ...
    try:
        for elem in keywords:
            ...
            try:
                ...
                continue
                # payload = {
                #     "text": "On website https://ec.europa.eu/ with key word: " + elem + " ```" + "No new matches found" + " ```"}
                # response = requests.post("https://hooks.slack.com/services/T14NAEEBZ/B038S999Y3W"
                #                          "/aee3kf3xwgnMr0Nq5jKxwXFW", json.dumps(payload))
    except:
        return False
